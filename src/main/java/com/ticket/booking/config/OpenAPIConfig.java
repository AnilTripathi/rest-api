...
public class OpenAPIConfig {
	...
	@Value("${ticket.booking.openapi.dev-url}")
	private String devUrl;

	@Value("${ticket.booking.openapi.prod-url}")
	...
	OpenAPI myOpenAPI() {
		...
		Info info = new Info().title("Ticket Booking Management API").version("1.0").contact(contact)
